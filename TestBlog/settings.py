...
SECRET_KEY = 'g8$xvme()a7+xis@2kyqpa+r0s&a1)+@j=*=)m9)$i2dz))*c7'
...
INSTALLED_APPS = [
    ...
    'custom_messages',
    'comment',
    'custom_tags_and_context_processors',
    'hitcount',
    'password',
    'rating',
    'registration',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'custom_tags_and_context_processors.context_processors.popular_articles',
